...
public class EventController {
    ...
    private final mk.ukim.finki.wp.lab.service.EventService EventService;
    private final LocationService locationService;
    private final CategoryService categoryService;
    private List<Event> found_events;

    public EventController(EventBookingService bookings, mk.ukim.finki.wp.lab.service.EventService eventService, LocationService locationService, CategoryService categoryService) {
        Bookings = bookings;
